...
exports.getHolds = (data) => {
  const document = parse5.parse(data)
  console.log(data)

  try {
    console.log(document.childNodes[8].childNodes[2].childNodes[1].childNodes[11].childNodes[1].childNodes[4].childNodes[1].childNodes[4])
    return false
  } catch (e) {
    return false
  }
...
const cleanseObject = (object, page) => {
